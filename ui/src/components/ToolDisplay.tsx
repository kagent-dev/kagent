      ...
      <CardContent className="min-w-0 overflow-hidden">
        <div className="space-y-2 mt-4">
          ...
          {areArgumentsExpanded && (
            <div className="relative max-h-96 w-full overflow-auto overscroll-contain rounded-md bg-muted/50 p-4">
        ...
        <div className="mt-4 w-full min-w-0 space-y-4 overflow-hidden">
          ...
          {hasResult && (
            <div className="isolate w-full min-w-0 max-w-full border-t pt-3">
              ...
              {areResultsExpanded && (
                <div className="relative min-w-0 max-w-full overflow-hidden">
                  <div className={`mt-2 max-h-96 w-full min-w-0 max-w-full overflow-auto overscroll-contain rounded-md border p-4 ${isError ? 'bg-red-50 dark:bg-red-950/10' : 'bg-muted/50'}`}>
                    <pre className={`max-w-full text-sm whitespace-pre-wrap break-all ${isError ? 'text-red-600 dark:text-red-400' : ''}`}>
                      {result.content}
                    </pre>
                  </div>
          ...
          {shouldRenderMcpApp && (
            <div className="isolate w-full overflow-visible">
              <McpAppRenderer
