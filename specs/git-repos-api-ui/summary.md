...
| `specs/git-repos-api-ui/plan.md` | 13-step implementation plan, each step demoable |
...
| `specs/git-repos-api-ui/research/08-ast-grep.md` | ast-grep structural search |
...
- ast-grep CLI wrapper for AST pattern search
