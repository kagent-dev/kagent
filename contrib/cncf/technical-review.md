...
- **Dependency Scanning**: Automated [CVE scanning via Trivy in CI/CD](https://github.com/kagent-dev/kagent/blob/main/.github/workflows/image-scan.yaml)
- **SBOM Generation**: Part of the [future state of the project](https://github.com/kagent-dev/kagent/blob/main/contrib/cncf/security-self-assessment.md#future-state)
