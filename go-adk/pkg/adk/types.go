...
// GetTimeout returns the timeout value or default if not set
// This is a go-adk specific extension method
func (r *RemoteAgentConfig) GetTimeout() float64 {
	// Note: controller's RemoteAgentConfig doesn't have Timeout field
	// This method is kept for backward compatibility in go-adk
	return 1800.0 // Default: 30 minutes (KAGENT_REMOTE_AGENT_TIMEOUT)
}
