...
func NewSessionServiceAdapter(service SessionService, logger logr.Logger) *SessionServiceAdapter {
...
func NewEventsWrapperForSession(session *Session) *EventsWrapper {
