...
slack_messages_total = Counter(
    "slack_messages_total", "Total Slack messages processed", ["event_type", "status"]
)

slack_message_duration_seconds = Histogram(
    "slack_message_duration_seconds", "Message processing duration", ["event_type"]
)

slack_commands_total = Counter("slack_commands_total", "Total slash commands", ["command", "status"])

agent_invocations_total = Counter(
    "agent_invocations_total", "Total agent invocations", ["agent", "status"]
)
