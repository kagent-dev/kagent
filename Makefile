...
BYO_A2A_E2E_IMAGE_NAME ?= byo-a2a
...
BYO_A2A_E2E_IMG ?= $(DOCKER_REGISTRY)/$(DOCKER_REPO)/$(BYO_A2A_E2E_IMAGE_NAME):$(BYO_A2A_E2E_IMAGE_TAG)
...
build-byo-a2a: buildx-create
	$(DOCKER_BUILDER) $(DOCKER_BUILD_ARGS) $(TOOLS_IMAGE_BUILD_ARGS) --build-arg BUILD_PACKAGE=core/test/byoa2a/main.go -t $(BYO_A2A_E2E_IMG) -f go/Dockerfile ./go
	$(DOCKER_PUSH) $(BYO_A2A_E2E_IMG)
