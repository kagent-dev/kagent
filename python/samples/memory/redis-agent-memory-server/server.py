...
# Try to import from agent_memory_client, handling potential missing types
try:
    from agent_memory_client import MemoryAPIClient
except ImportError:
    raise ImportError("Please install agent-memory-client: pip install agent-memory-client")
...
def add_session_to_memory(session: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return client.set_working_memory(
