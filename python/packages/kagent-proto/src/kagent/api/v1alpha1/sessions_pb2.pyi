...
class CreateTaskRequest(_message.Message):
    ...
    task: _common_pb2.StructuredObject
    def __init__(self, task: _Optional[_Union[_common_pb2.StructuredObject, _Mapping]] = ...) -> None: ...
...
class ListTasksResponse(_message.Message):
    ...
    tasks: _containers.RepeatedCompositeFieldContainer[_common_pb2.StructuredObject]
    def __init__(self, tasks: _Optional[_Iterable[_Union[_common_pb2.StructuredObject, _Mapping]]] = ...) -> None: ...
