...
func handleIstioProxyStatus(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	result, err := common.RunCommand("istioctl", args)
	if err != nil {
...
// Istio analyze
func handleIstioAnalyze(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	namespace := mcp.ParseString(request, "namespace", "")
...
func RegisterIstioTools(s *server.MCPServer) {
	...
	// Istio install
	s.AddTool(mcp.NewTool("istio_install",
	...
	// Istio analyze
	s.AddTool(mcp.NewTool("istio_analyze",
	...
	// Waypoint list
	s.AddTool(mcp.NewTool("waypoint_list",
	...
	// Waypoint generate
	s.AddTool(mcp.NewTool("waypoint_generate",
	...
	// Waypoint apply
	s.AddTool(mcp.NewTool("waypoint_apply",
	...
	// Waypoint delete
	s.AddTool(mcp.NewTool("waypoint_delete",
	...
	// Waypoint status
	s.AddTool(mcp.NewTool("waypoint_status",
	...
	// Ztunnel config
	s.AddTool(mcp.NewTool("ztunnel_config",
