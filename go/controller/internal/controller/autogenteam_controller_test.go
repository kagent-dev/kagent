...
func TestAutogenTeamController(t *testing.T) {
	t.Run("When reconciling a resource", func(t *testing.T) {
		...
		// Setup - creating the custom resource for the Kind AutogenTeam
		...
		t.Cleanup(func() {
			...
			// Cleanup the specific resource instance AutogenTeam
