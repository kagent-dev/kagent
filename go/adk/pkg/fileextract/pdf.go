...
// extractPDF prefers tabula's markdown, which garbles Type3 fonts (no ToUnicode)
// and fails on some malformed streams; those fall back to extractPDFText.
...
// extractPDFText extracts page by page with Type3 fonts' ToUnicode CMaps
// registered, skipping pages or streams that fail to parse.
