...
type Client struct {
	...
	taskService     apiv1alpha1.TaskServiceClient
...
func New(config Config) (*Client, error) {
	...
	return &Client{
		...
		taskService:     apiv1alpha1.NewTaskServiceClient(connection),
...
func (client *Client) TaskService() apiv1alpha1.TaskServiceClient {
