...
type Sandbox struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Stable sandbox ID generated by the gateway.
	Id string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	// User-visible sandbox name.
	Name string `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	// Namespace used by the backing compute platform.
...
const file_openshell_proto_rawDesc = "" +
	...
	"\aversion\x18\x02 \x01(\tR\aversion\"\xbb\x02\n" +
	"\aSandbox\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x1c\n" +
	"\tnamespace\x18\x03 \x01(\tR\tnamespace\x12-\n" +
	"\x04spec\x18\x04 \x01(\v2\x19.openshell.v1.SandboxSpecR\x04spec\x123\n" +
	"\x06status\x18\x05 \x01(\v2\x1b.openshell.v1.SandboxStatusR\x06status\x120\n" +
	"\x05phase\x18\x06 \x01(\x0e2\x1a.openshell.v1.SandboxPhaseR\x05phase\x12\"\n" +
	"\rcreated_at_ms\x18\a \x01(\x03R\vcreatedAtMs\x124\n" +
	"\x16current_policy_version\x18\b \x01(\rR\x14currentPolicyVersion\"\xe0\x02\n" +
	...
	"\aentries\x18\x01 \x03(\v2\x1f.openshell.v1.DraftHistoryEntryR\aentries*\xb6\x01\n" +
...
var file_openshell_proto_msgTypes = make([]protoimpl.MessageInfo, 102)
var file_openshell_proto_goTypes = []any{
	...
	nil,                                           // 97: openshell.v1.SandboxSpec.EnvironmentEntry
	nil,                                           // 98: openshell.v1.SandboxTemplate.LabelsEntry
	nil,                                           // 99: openshell.v1.SandboxTemplate.AnnotationsEntry
	nil,                                           // 100: openshell.v1.SandboxTemplate.EnvironmentEntry
	nil,                                           // 101: openshell.v1.PlatformEvent.MetadataEntry
	nil,                                           // 102: openshell.v1.ExecSandboxRequest.EnvironmentEntry
	nil,                                           // 103: openshell.v1.SandboxLogLine.FieldsEntry
	nil,                                           // 104: openshell.v1.GetSandboxProviderEnvironmentResponse.EnvironmentEntry
	(*sandboxv1.SandboxPolicy)(nil),               // 105: openshell.sandbox.v1.SandboxPolicy
	(*structpb.Struct)(nil),                       // 106: google.protobuf.Struct
	(*datamodelv1.Provider)(nil),                  // 107: openshell.datamodel.v1.Provider
	(*sandboxv1.SettingValue)(nil),                // 108: openshell.sandbox.v1.SettingValue
	(*sandboxv1.NetworkPolicyRule)(nil),           // 109: openshell.sandbox.v1.NetworkPolicyRule
	(*sandboxv1.L7DenyRule)(nil),                  // 110: openshell.sandbox.v1.L7DenyRule
	(*sandboxv1.L7Rule)(nil),                      // 111: openshell.sandbox.v1.L7Rule
	(*sandboxv1.GetSandboxConfigRequest)(nil),     // 112: openshell.sandbox.v1.GetSandboxConfigRequest
	(*sandboxv1.GetGatewayConfigRequest)(nil),     // 113: openshell.sandbox.v1.GetGatewayConfigRequest
	(*sandboxv1.GetSandboxConfigResponse)(nil),    // 114: openshell.sandbox.v1.GetSandboxConfigResponse
	(*sandboxv1.GetGatewayConfigResponse)(nil),    // 115: openshell.sandbox.v1.GetGatewayConfigResponse
}
var file_openshell_proto_depIdxs = []int32{
	2,   // 0: openshell.v1.HealthResponse.status:type_name -> openshell.v1.ServiceStatus
	6,   // 1: openshell.v1.Sandbox.spec:type_name -> openshell.v1.SandboxSpec
	8,   // 2: openshell.v1.Sandbox.status:type_name -> openshell.v1.SandboxStatus
	0,   // 3: openshell.v1.Sandbox.phase:type_name -> openshell.v1.SandboxPhase
	97,  // 4: openshell.v1.SandboxSpec.environment:type_name -> openshell.v1.SandboxSpec.EnvironmentEntry
	7,   // 5: openshell.v1.SandboxSpec.template:type_name -> openshell.v1.SandboxTemplate
	105, // 6: openshell.v1.SandboxSpec.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	98,  // 7: openshell.v1.SandboxTemplate.labels:type_name -> openshell.v1.SandboxTemplate.LabelsEntry
	99,  // 8: openshell.v1.SandboxTemplate.annotations:type_name -> openshell.v1.SandboxTemplate.AnnotationsEntry
	100, // 9: openshell.v1.SandboxTemplate.environment:type_name -> openshell.v1.SandboxTemplate.EnvironmentEntry
	106, // 10: openshell.v1.SandboxTemplate.resources:type_name -> google.protobuf.Struct
	106, // 11: openshell.v1.SandboxTemplate.volume_claim_templates:type_name -> google.protobuf.Struct
	9,   // 12: openshell.v1.SandboxStatus.conditions:type_name -> openshell.v1.SandboxCondition
	101, // 13: openshell.v1.PlatformEvent.metadata:type_name -> openshell.v1.PlatformEvent.MetadataEntry
	6,   // 14: openshell.v1.CreateSandboxRequest.spec:type_name -> openshell.v1.SandboxSpec
	5,   // 15: openshell.v1.SandboxResponse.sandbox:type_name -> openshell.v1.Sandbox
	5,   // 16: openshell.v1.ListSandboxesResponse.sandboxes:type_name -> openshell.v1.Sandbox
	102, // 17: openshell.v1.ExecSandboxRequest.environment:type_name -> openshell.v1.ExecSandboxRequest.EnvironmentEntry
	23,  // 18: openshell.v1.ExecSandboxEvent.stdout:type_name -> openshell.v1.ExecSandboxStdout
	24,  // 19: openshell.v1.ExecSandboxEvent.stderr:type_name -> openshell.v1.ExecSandboxStderr
	25,  // 20: openshell.v1.ExecSandboxEvent.exit:type_name -> openshell.v1.ExecSandboxExit
	5,   // 21: openshell.v1.SandboxStreamEvent.sandbox:type_name -> openshell.v1.Sandbox
	30,  // 22: openshell.v1.SandboxStreamEvent.log:type_name -> openshell.v1.SandboxLogLine
	10,  // 23: openshell.v1.SandboxStreamEvent.event:type_name -> openshell.v1.PlatformEvent
	31,  // 24: openshell.v1.SandboxStreamEvent.warning:type_name -> openshell.v1.SandboxStreamWarning
	77,  // 25: openshell.v1.SandboxStreamEvent.draft_policy_update:type_name -> openshell.v1.DraftPolicyUpdate
	103, // 26: openshell.v1.SandboxLogLine.fields:type_name -> openshell.v1.SandboxLogLine.FieldsEntry
	107, // 27: openshell.v1.CreateProviderRequest.provider:type_name -> openshell.datamodel.v1.Provider
	107, // 28: openshell.v1.UpdateProviderRequest.provider:type_name -> openshell.datamodel.v1.Provider
	107, // 29: openshell.v1.ProviderResponse.provider:type_name -> openshell.datamodel.v1.Provider
	107, // 30: openshell.v1.ListProvidersResponse.providers:type_name -> openshell.datamodel.v1.Provider
	104, // 31: openshell.v1.GetSandboxProviderEnvironmentResponse.environment:type_name -> openshell.v1.GetSandboxProviderEnvironmentResponse.EnvironmentEntry
	105, // 32: openshell.v1.UpdateConfigRequest.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	108, // 33: openshell.v1.UpdateConfigRequest.setting_value:type_name -> openshell.sandbox.v1.SettingValue
	43,  // 34: openshell.v1.UpdateConfigRequest.merge_operations:type_name -> openshell.v1.PolicyMergeOperation
	44,  // 35: openshell.v1.PolicyMergeOperation.add_rule:type_name -> openshell.v1.AddNetworkRule
	45,  // 36: openshell.v1.PolicyMergeOperation.remove_endpoint:type_name -> openshell.v1.RemoveNetworkEndpoint
	46,  // 37: openshell.v1.PolicyMergeOperation.remove_rule:type_name -> openshell.v1.RemoveNetworkRule
	47,  // 38: openshell.v1.PolicyMergeOperation.add_deny_rules:type_name -> openshell.v1.AddDenyRules
	48,  // 39: openshell.v1.PolicyMergeOperation.add_allow_rules:type_name -> openshell.v1.AddAllowRules
	49,  // 40: openshell.v1.PolicyMergeOperation.remove_binary:type_name -> openshell.v1.RemoveNetworkBinary
	109, // 41: openshell.v1.AddNetworkRule.rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	110, // 42: openshell.v1.AddDenyRules.deny_rules:type_name -> openshell.sandbox.v1.L7DenyRule
	111, // 43: openshell.v1.AddAllowRules.rules:type_name -> openshell.sandbox.v1.L7Rule
	57,  // 44: openshell.v1.GetSandboxPolicyStatusResponse.revision:type_name -> openshell.v1.SandboxPolicyRevision
	57,  // 45: openshell.v1.ListSandboxPoliciesResponse.revisions:type_name -> openshell.v1.SandboxPolicyRevision
	1,   // 46: openshell.v1.ReportPolicyStatusRequest.status:type_name -> openshell.v1.PolicyStatus
	1,   // 47: openshell.v1.SandboxPolicyRevision.status:type_name -> openshell.v1.PolicyStatus
	105, // 48: openshell.v1.SandboxPolicyRevision.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	30,  // 49: openshell.v1.PushSandboxLogsRequest.logs:type_name -> openshell.v1.SandboxLogLine
	30,  // 50: openshell.v1.GetSandboxLogsResponse.logs:type_name -> openshell.v1.SandboxLogLine
	64,  // 51: openshell.v1.SupervisorMessage.hello:type_name -> openshell.v1.SupervisorHello
	67,  // 52: openshell.v1.SupervisorMessage.heartbeat:type_name -> openshell.v1.SupervisorHeartbeat
	72,  // 53: openshell.v1.SupervisorMessage.relay_open_result:type_name -> openshell.v1.RelayOpenResult
	73,  // 54: openshell.v1.SupervisorMessage.relay_close:type_name -> openshell.v1.RelayClose
	65,  // 55: openshell.v1.GatewayMessage.session_accepted:type_name -> openshell.v1.SessionAccepted
	66,  // 56: openshell.v1.GatewayMessage.session_rejected:type_name -> openshell.v1.SessionRejected
	68,  // 57: openshell.v1.GatewayMessage.heartbeat:type_name -> openshell.v1.GatewayHeartbeat
	69,  // 58: openshell.v1.GatewayMessage.relay_open:type_name -> openshell.v1.RelayOpen
	73,  // 59: openshell.v1.GatewayMessage.relay_close:type_name -> openshell.v1.RelayClose
	70,  // 60: openshell.v1.RelayFrame.init:type_name -> openshell.v1.RelayInit
	74,  // 61: openshell.v1.DenialSummary.l7_request_samples:type_name -> openshell.v1.L7RequestSample
	109, // 62: openshell.v1.PolicyChunk.proposed_rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	75,  // 63: openshell.v1.SubmitPolicyAnalysisRequest.summaries:type_name -> openshell.v1.DenialSummary
	76,  // 64: openshell.v1.SubmitPolicyAnalysisRequest.proposed_chunks:type_name -> openshell.v1.PolicyChunk
	76,  // 65: openshell.v1.GetDraftPolicyResponse.chunks:type_name -> openshell.v1.PolicyChunk
	109, // 66: openshell.v1.EditDraftChunkRequest.proposed_rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	95,  // 67: openshell.v1.GetDraftHistoryResponse.entries:type_name -> openshell.v1.DraftHistoryEntry
	3,   // 68: openshell.v1.OpenShell.Health:input_type -> openshell.v1.HealthRequest
	11,  // 69: openshell.v1.OpenShell.CreateSandbox:input_type -> openshell.v1.CreateSandboxRequest
	12,  // 70: openshell.v1.OpenShell.GetSandbox:input_type -> openshell.v1.GetSandboxRequest
	13,  // 71: openshell.v1.OpenShell.ListSandboxes:input_type -> openshell.v1.ListSandboxesRequest
	14,  // 72: openshell.v1.OpenShell.DeleteSandbox:input_type -> openshell.v1.DeleteSandboxRequest
	18,  // 73: openshell.v1.OpenShell.CreateSshSession:input_type -> openshell.v1.CreateSshSessionRequest
	20,  // 74: openshell.v1.OpenShell.RevokeSshSession:input_type -> openshell.v1.RevokeSshSessionRequest
	22,  // 75: openshell.v1.OpenShell.ExecSandbox:input_type -> openshell.v1.ExecSandboxRequest
	32,  // 76: openshell.v1.OpenShell.CreateProvider:input_type -> openshell.v1.CreateProviderRequest
	33,  // 77: openshell.v1.OpenShell.GetProvider:input_type -> openshell.v1.GetProviderRequest
	34,  // 78: openshell.v1.OpenShell.ListProviders:input_type -> openshell.v1.ListProvidersRequest
	35,  // 79: openshell.v1.OpenShell.UpdateProvider:input_type -> openshell.v1.UpdateProviderRequest
	36,  // 80: openshell.v1.OpenShell.DeleteProvider:input_type -> openshell.v1.DeleteProviderRequest
	112, // 81: openshell.v1.OpenShell.GetSandboxConfig:input_type -> openshell.sandbox.v1.GetSandboxConfigRequest
	113, // 82: openshell.v1.OpenShell.GetGatewayConfig:input_type -> openshell.sandbox.v1.GetGatewayConfigRequest
	42,  // 83: openshell.v1.OpenShell.UpdateConfig:input_type -> openshell.v1.UpdateConfigRequest
	51,  // 84: openshell.v1.OpenShell.GetSandboxPolicyStatus:input_type -> openshell.v1.GetSandboxPolicyStatusRequest
	53,  // 85: openshell.v1.OpenShell.ListSandboxPolicies:input_type -> openshell.v1.ListSandboxPoliciesRequest
	55,  // 86: openshell.v1.OpenShell.ReportPolicyStatus:input_type -> openshell.v1.ReportPolicyStatusRequest
	40,  // 87: openshell.v1.OpenShell.GetSandboxProviderEnvironment:input_type -> openshell.v1.GetSandboxProviderEnvironmentRequest
	58,  // 88: openshell.v1.OpenShell.GetSandboxLogs:input_type -> openshell.v1.GetSandboxLogsRequest
	59,  // 89: openshell.v1.OpenShell.PushSandboxLogs:input_type -> openshell.v1.PushSandboxLogsRequest
	62,  // 90: openshell.v1.OpenShell.ConnectSupervisor:input_type -> openshell.v1.SupervisorMessage
	71,  // 91: openshell.v1.OpenShell.RelayStream:input_type -> openshell.v1.RelayFrame
	28,  // 92: openshell.v1.OpenShell.WatchSandbox:input_type -> openshell.v1.WatchSandboxRequest
	78,  // 93: openshell.v1.OpenShell.SubmitPolicyAnalysis:input_type -> openshell.v1.SubmitPolicyAnalysisRequest
	80,  // 94: openshell.v1.OpenShell.GetDraftPolicy:input_type -> openshell.v1.GetDraftPolicyRequest
	82,  // 95: openshell.v1.OpenShell.ApproveDraftChunk:input_type -> openshell.v1.ApproveDraftChunkRequest
	84,  // 96: openshell.v1.OpenShell.RejectDraftChunk:input_type -> openshell.v1.RejectDraftChunkRequest
	86,  // 97: openshell.v1.OpenShell.ApproveAllDraftChunks:input_type -> openshell.v1.ApproveAllDraftChunksRequest
	88,  // 98: openshell.v1.OpenShell.EditDraftChunk:input_type -> openshell.v1.EditDraftChunkRequest
	90,  // 99: openshell.v1.OpenShell.UndoDraftChunk:input_type -> openshell.v1.UndoDraftChunkRequest
	92,  // 100: openshell.v1.OpenShell.ClearDraftChunks:input_type -> openshell.v1.ClearDraftChunksRequest
	94,  // 101: openshell.v1.OpenShell.GetDraftHistory:input_type -> openshell.v1.GetDraftHistoryRequest
	4,   // 102: openshell.v1.OpenShell.Health:output_type -> openshell.v1.HealthResponse
	15,  // 103: openshell.v1.OpenShell.CreateSandbox:output_type -> openshell.v1.SandboxResponse
	15,  // 104: openshell.v1.OpenShell.GetSandbox:output_type -> openshell.v1.SandboxResponse
	16,  // 105: openshell.v1.OpenShell.ListSandboxes:output_type -> openshell.v1.ListSandboxesResponse
	17,  // 106: openshell.v1.OpenShell.DeleteSandbox:output_type -> openshell.v1.DeleteSandboxResponse
	19,  // 107: openshell.v1.OpenShell.CreateSshSession:output_type -> openshell.v1.CreateSshSessionResponse
	21,  // 108: openshell.v1.OpenShell.RevokeSshSession:output_type -> openshell.v1.RevokeSshSessionResponse
	26,  // 109: openshell.v1.OpenShell.ExecSandbox:output_type -> openshell.v1.ExecSandboxEvent
	37,  // 110: openshell.v1.OpenShell.CreateProvider:output_type -> openshell.v1.ProviderResponse
	37,  // 111: openshell.v1.OpenShell.GetProvider:output_type -> openshell.v1.ProviderResponse
	38,  // 112: openshell.v1.OpenShell.ListProviders:output_type -> openshell.v1.ListProvidersResponse
	37,  // 113: openshell.v1.OpenShell.UpdateProvider:output_type -> openshell.v1.ProviderResponse
	39,  // 114: openshell.v1.OpenShell.DeleteProvider:output_type -> openshell.v1.DeleteProviderResponse
	114, // 115: openshell.v1.OpenShell.GetSandboxConfig:output_type -> openshell.sandbox.v1.GetSandboxConfigResponse
	115, // 116: openshell.v1.OpenShell.GetGatewayConfig:output_type -> openshell.sandbox.v1.GetGatewayConfigResponse
	50,  // 117: openshell.v1.OpenShell.UpdateConfig:output_type -> openshell.v1.UpdateConfigResponse
	52,  // 118: openshell.v1.OpenShell.GetSandboxPolicyStatus:output_type -> openshell.v1.GetSandboxPolicyStatusResponse
	54,  // 119: openshell.v1.OpenShell.ListSandboxPolicies:output_type -> openshell.v1.ListSandboxPoliciesResponse
	56,  // 120: openshell.v1.OpenShell.ReportPolicyStatus:output_type -> openshell.v1.ReportPolicyStatusResponse
	41,  // 121: openshell.v1.OpenShell.GetSandboxProviderEnvironment:output_type -> openshell.v1.GetSandboxProviderEnvironmentResponse
	61,  // 122: openshell.v1.OpenShell.GetSandboxLogs:output_type -> openshell.v1.GetSandboxLogsResponse
	60,  // 123: openshell.v1.OpenShell.PushSandboxLogs:output_type -> openshell.v1.PushSandboxLogsResponse
	63,  // 124: openshell.v1.OpenShell.ConnectSupervisor:output_type -> openshell.v1.GatewayMessage
	71,  // 125: openshell.v1.OpenShell.RelayStream:output_type -> openshell.v1.RelayFrame
	29,  // 126: openshell.v1.OpenShell.WatchSandbox:output_type -> openshell.v1.SandboxStreamEvent
	79,  // 127: openshell.v1.OpenShell.SubmitPolicyAnalysis:output_type -> openshell.v1.SubmitPolicyAnalysisResponse
	81,  // 128: openshell.v1.OpenShell.GetDraftPolicy:output_type -> openshell.v1.GetDraftPolicyResponse
	83,  // 129: openshell.v1.OpenShell.ApproveDraftChunk:output_type -> openshell.v1.ApproveDraftChunkResponse
	85,  // 130: openshell.v1.OpenShell.RejectDraftChunk:output_type -> openshell.v1.RejectDraftChunkResponse
	87,  // 131: openshell.v1.OpenShell.ApproveAllDraftChunks:output_type -> openshell.v1.ApproveAllDraftChunksResponse
	89,  // 132: openshell.v1.OpenShell.EditDraftChunk:output_type -> openshell.v1.EditDraftChunkResponse
	91,  // 133: openshell.v1.OpenShell.UndoDraftChunk:output_type -> openshell.v1.UndoDraftChunkResponse
	93,  // 134: openshell.v1.OpenShell.ClearDraftChunks:output_type -> openshell.v1.ClearDraftChunksResponse
	96,  // 135: openshell.v1.OpenShell.GetDraftHistory:output_type -> openshell.v1.GetDraftHistoryResponse
