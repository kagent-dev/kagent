...
var file_sandbox_proto_goTypes = []any{
	...
	(*L7Rule)(nil),                   // 9: openshell.sandbox.v1.L7Rule
	(*L7Allow)(nil),                  // 10: openshell.sandbox.v1.L7Allow
	(*L7QueryMatcher)(nil),           // 11: openshell.sandbox.v1.L7QueryMatcher
	(*NetworkBinary)(nil),            // 12: openshell.sandbox.v1.NetworkBinary
	...
	(*GetGatewayConfigResponse)(nil), // 15: openshell.sandbox.v1.GetGatewayConfigResponse
	(*SettingValue)(nil),             // 16: openshell.sandbox.v1.SettingValue
	(*EffectiveSetting)(nil),         // 17: openshell.sandbox.v1.EffectiveSetting
	(*GetSandboxConfigResponse)(nil), // 18: openshell.sandbox.v1.GetSandboxConfigResponse
	nil,                              // 19: openshell.sandbox.v1.SandboxPolicy.NetworkPoliciesEntry
	nil,                              // 20: openshell.sandbox.v1.L7DenyRule.QueryEntry
	nil,                              // 21: openshell.sandbox.v1.L7Allow.QueryEntry
	nil,                              // 22: openshell.sandbox.v1.GetGatewayConfigResponse.SettingsEntry
	nil,                              // 23: openshell.sandbox.v1.GetSandboxConfigResponse.SettingsEntry
}
var file_sandbox_proto_depIdxs = []int32{
	...
	19, // 3: openshell.sandbox.v1.SandboxPolicy.network_policies:type_name -> openshell.sandbox.v1.SandboxPolicy.NetworkPoliciesEntry
	7,  // 4: openshell.sandbox.v1.NetworkPolicyRule.endpoints:type_name -> openshell.sandbox.v1.NetworkEndpoint
	12, // 5: openshell.sandbox.v1.NetworkPolicyRule.binaries:type_name -> openshell.sandbox.v1.NetworkBinary
	9,  // 6: openshell.sandbox.v1.NetworkEndpoint.rules:type_name -> openshell.sandbox.v1.L7Rule
	8,  // 7: openshell.sandbox.v1.NetworkEndpoint.deny_rules:type_name -> openshell.sandbox.v1.L7DenyRule
	20, // 8: openshell.sandbox.v1.L7DenyRule.query:type_name -> openshell.sandbox.v1.L7DenyRule.QueryEntry
	10, // 9: openshell.sandbox.v1.L7Rule.allow:type_name -> openshell.sandbox.v1.L7Allow
	21, // 10: openshell.sandbox.v1.L7Allow.query:type_name -> openshell.sandbox.v1.L7Allow.QueryEntry
	22, // 11: openshell.sandbox.v1.GetGatewayConfigResponse.settings:type_name -> openshell.sandbox.v1.GetGatewayConfigResponse.SettingsEntry
	16, // 12: openshell.sandbox.v1.EffectiveSetting.value:type_name -> openshell.sandbox.v1.SettingValue
	0,  // 13: openshell.sandbox.v1.EffectiveSetting.scope:type_name -> openshell.sandbox.v1.SettingScope
	2,  // 14: openshell.sandbox.v1.GetSandboxConfigResponse.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	23, // 15: openshell.sandbox.v1.GetSandboxConfigResponse.settings:type_name -> openshell.sandbox.v1.GetSandboxConfigResponse.SettingsEntry
	1,  // 16: openshell.sandbox.v1.GetSandboxConfigResponse.policy_source:type_name -> openshell.sandbox.v1.PolicySource
	6,  // 17: openshell.sandbox.v1.SandboxPolicy.NetworkPoliciesEntry.value:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	11, // 18: openshell.sandbox.v1.L7DenyRule.QueryEntry.value:type_name -> openshell.sandbox.v1.L7QueryMatcher
	11, // 19: openshell.sandbox.v1.L7Allow.QueryEntry.value:type_name -> openshell.sandbox.v1.L7QueryMatcher
	16, // 20: openshell.sandbox.v1.GetGatewayConfigResponse.SettingsEntry.value:type_name -> openshell.sandbox.v1.SettingValue
	17, // 21: openshell.sandbox.v1.GetSandboxConfigResponse.SettingsEntry.value:type_name -> openshell.sandbox.v1.EffectiveSetting
...
func file_sandbox_proto_init() {
	...
	file_sandbox_proto_msgTypes[14].OneofWrappers = []any{
