...
func (service *recordingTaskService) ListTasks(ctx context.Context, _ *apiv1alpha1.ListTasksRequest) (*apiv1alpha1.ListTasksResponse, error) {
	...
	encoded, err := structuredobject.FromGo(task, "lf.a2a.v1", "Task", defaultGRPCMaxMessageSize)
	if err != nil {
		return nil, err
	}
	return &apiv1alpha1.ListTasksResponse{Tasks: []*apiv1alpha1.StructuredObject{encoded}}, nil
}
...
func TestSessionClientUsesGeneratedGRPC(t *testing.T) {
	...
	apiv1alpha1.RegisterTaskServiceServer(server, taskService)
