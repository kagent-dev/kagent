...
func (c *BaseClient) encodeModelConfig(spec v1alpha2.ModelConfigSpec) (*apiv1alpha1.StructuredObject, error) {
	resource, err := structuredobject.FromGo(
		&v1alpha2.ModelConfig{Spec: spec},
