...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GDCServiceAccountConfig) DeepCopyInto(out *GDCServiceAccountConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GDCServiceAccountConfig.
func (in *GDCServiceAccountConfig) DeepCopy() *GDCServiceAccountConfig {
	if in == nil {
		return nil
	}
	out := new(GDCServiceAccountConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TokenExchangeConfig) DeepCopyInto(out *TokenExchangeConfig) {
	*out = *in
	if in.GDCServiceAccount != nil {
		in, out := &in.GDCServiceAccount, &out.GDCServiceAccount
		*out = new(GDCServiceAccountConfig)
		**out = **in
	}
}
