...
func (in *ContextConfig) DeepCopyInto(out *ContextConfig) {
	*out = *in
	...
	if in.WindowCompression != nil {
		in, out := &in.WindowCompression, &out.WindowCompression
		*out = new(ContextWindowCompressionConfig)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ContextWindowCompressionConfig) DeepCopyInto(out *ContextWindowCompressionConfig) {
	*out = *in
	if in.MaxLength != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ContextWindowCompressionConfig.
func (in *ContextWindowCompressionConfig) DeepCopy() *ContextWindowCompressionConfig {
	if in == nil {
		return nil
	}
	out := new(ContextWindowCompressionConfig)
