...
func (in *DeclarativeAgentSpec) DeepCopyInto(out *DeclarativeAgentSpec) {
	*out = *in
	...
	if in.SessionNameGeneration != nil {
		in, out := &in.SessionNameGeneration, &out.SessionNameGeneration
		*out = new(SessionNameGenerationConfig)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SessionNameGenerationConfig) DeepCopyInto(out *SessionNameGenerationConfig) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SessionNameGenerationConfig.
func (in *SessionNameGenerationConfig) DeepCopy() *SessionNameGenerationConfig {
	if in == nil {
		return nil
	}
	out := new(SessionNameGenerationConfig)
