...
var file_kagent_api_v1alpha1_agent_instances_proto_depIdxs = []int32{
	...
	28, // 8: kagent.api.v1alpha1.CreateAgentInstanceRequest.harness:type_name -> kagent.api.v1alpha1.ResourceReference
	28, // 9: kagent.api.v1alpha1.CreateAgentInstanceRequest.agent_template:type_name -> kagent.api.v1alpha1.ResourceReference
	4,  // 10: kagent.api.v1alpha1.CreateAgentInstanceResponse.agent_instance:type_name -> kagent.api.v1alpha1.AgentInstance
	4,  // 11: kagent.api.v1alpha1.GetAgentInstanceResponse.agent_instance:type_name -> kagent.api.v1alpha1.AgentInstance
	27, // 12: kagent.api.v1alpha1.ListAgentInstancesRequest.match_labels:type_name -> kagent.api.v1alpha1.ListAgentInstancesRequest.MatchLabelsEntry
	30, // 13: kagent.api.v1alpha1.ListAgentInstancesRequest.page:type_name -> kagent.api.v1alpha1.PageRequest
	28, // 14: kagent.api.v1alpha1.ListAgentInstancesRequest.agent_template:type_name -> kagent.api.v1alpha1.ResourceReference
	28, // 15: kagent.api.v1alpha1.ListAgentInstancesRequest.harness:type_name -> kagent.api.v1alpha1.ResourceReference
	4,  // 16: kagent.api.v1alpha1.ListAgentInstancesResponse.agent_instances:type_name -> kagent.api.v1alpha1.AgentInstance
	31, // 17: kagent.api.v1alpha1.ListAgentInstancesResponse.page:type_name -> kagent.api.v1alpha1.PageResponse
	4,  // 18: kagent.api.v1alpha1.UpdateAgentInstanceNameResponse.agent_instance:type_name -> kagent.api.v1alpha1.AgentInstance
	4,  // 19: kagent.api.v1alpha1.SuspendAgentInstanceResponse.agent_instance:type_name -> kagent.api.v1alpha1.AgentInstance
	4,  // 20: kagent.api.v1alpha1.ResumeAgentInstanceResponse.agent_instance:type_name -> kagent.api.v1alpha1.AgentInstance
	4,  // 21: kagent.api.v1alpha1.DeleteAgentInstanceResponse.agent_instance:type_name -> kagent.api.v1alpha1.AgentInstance
	2,  // 22: kagent.api.v1alpha1.AgentInstanceShare.permission:type_name -> kagent.api.v1alpha1.AgentInstanceSharePermission
	29, // 23: kagent.api.v1alpha1.AgentInstanceShare.created_at:type_name -> google.protobuf.Timestamp
	2,  // 24: kagent.api.v1alpha1.CreateAgentInstanceShareRequest.permission:type_name -> kagent.api.v1alpha1.AgentInstanceSharePermission
	19, // 25: kagent.api.v1alpha1.CreateAgentInstanceShareResponse.share:type_name -> kagent.api.v1alpha1.AgentInstanceShare
	30, // 26: kagent.api.v1alpha1.ListAgentInstanceSharesRequest.page:type_name -> kagent.api.v1alpha1.PageRequest
	19, // 27: kagent.api.v1alpha1.ListAgentInstanceSharesResponse.shares:type_name -> kagent.api.v1alpha1.AgentInstanceShare
	31, // 28: kagent.api.v1alpha1.ListAgentInstanceSharesResponse.page:type_name -> kagent.api.v1alpha1.PageResponse
