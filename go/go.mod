...
require (
	...
	istio.io/api v1.31.0-alpha.0.0.20260807010025-694749c7b0cd // indirect
...
replace github.com/agent-substrate/substrate => github.com/kagent-dev/substrate v0.0.13
