...
type Querier interface {
	...
	GetAgentInstance(ctx context.Context, arg GetAgentInstanceParams) (AgentInstance, error)
	...
	GetOwnedAgentInstance(ctx context.Context, arg GetOwnedAgentInstanceParams) (AgentInstance, error)
	...
	ListAllAgentInstances(ctx context.Context, arg ListAllAgentInstancesParams) ([]AgentInstance, error)
	...
	ListOwnedAgentInstances(ctx context.Context, arg ListOwnedAgentInstancesParams) ([]AgentInstance, error)
