...
func TestAgentInstanceTasksAreDurableAndExclusive(t *testing.T) {
	...
	if _, err := db.Exec(ctx, `
		INSERT INTO agent_history (id, instance_id, user_id, context_id) VALUES ('11111111-1111-4111-8111-111111111111', '11111111-1111-4111-8111-111111111111', 'alice', '11111111-1111-4111-8111-111111111111');
