...
type SandboxActorCleaner interface {
	DeleteSandboxAgentSessionActor(context.Context, *v1alpha2.SandboxAgent, string) (bool, error)
}
...
func (s *Service) Delete(ctx context.Context, sessionID string) error {
	...
	var cleanup *v1alpha2.SandboxAgent
...
func (s *Service) lookupSubstrateSandboxAgent(ctx context.Context, agentRef string) (*v1alpha2.SandboxAgent, bool, error) {
	if s.kube == nil {
...
func (s *Service) substrateSandboxAgentForSession(ctx context.Context, session *database.Session) (*v1alpha2.SandboxAgent, error) {
