...
func TestCreateAndListUseAuthenticatedUser(t *testing.T) {
	...
	store.agents["default__NS__agent"] = &database.Agent{ID: "default__NS__agent", WorkloadType: v1alpha2.WorkloadModeDeployment}
...
func TestCreateEnforcesLegacySandboxSingleSession(t *testing.T) {
	store := newSessionTestStore()
	store.agents["default__NS__sandbox"] = &database.Agent{ID: "default__NS__sandbox", WorkloadType: v1alpha2.WorkloadModeSandbox}
