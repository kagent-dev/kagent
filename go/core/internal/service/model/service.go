...
func (s *Service) Get(ctx context.Context, request GetRequest) (*v1alpha3.ModelConfig, error) {
	...
	if err := s.authorize(ctx, auth.VerbGet, kubeauth.Resource("ModelConfig", modelConfig)); err != nil {
		return nil, err
	}
...
func (s *Service) Create(ctx context.Context, request CreateRequest) (*v1alpha3.ModelConfig, error) {
	...
	if err := s.authorize(ctx, auth.VerbCreate, kubeauth.Resource("ModelConfig", modelConfig)); err != nil {
		return nil, err
	}
...
func (s *Service) Update(ctx context.Context, request UpdateRequest) (*v1alpha3.ModelConfig, error) {
	...
	if err := s.authorize(ctx, auth.VerbUpdate, kubeauth.Resource("ModelConfig", modelConfig)); err != nil {
		return nil, err
	}
	...
	proposed.Spec = spec
	if err := s.authorize(ctx, auth.VerbUpdate, kubeauth.Resource("ModelConfig", proposed)); err != nil {
		return nil, err
	}
...
func (s *Service) Delete(ctx context.Context, request DeleteRequest) (*v1alpha3.ModelConfig, error) {
	...
	if err := s.authorize(ctx, auth.VerbDelete, kubeauth.Resource("ModelConfig", modelConfig)); err != nil {
		return nil, err
	}
