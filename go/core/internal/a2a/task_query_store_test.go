...
// ListTasksForUser mirrors the SQL query's semantics in memory: scope to the
...
func (f *fakeTaskStore) ListTasksForUser(_ context.Context, userID string, params dbpkg.ListTasksForUserParams) ([]*a2atype.Task, int, error) {
...
func (f failingTaskStore) ListTasksForUser(context.Context, string, dbpkg.ListTasksForUserParams) ([]*a2atype.Task, int, error) {
	return nil, 0, f.err
}
