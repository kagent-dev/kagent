...
func (h *ModelHandler) HandleListSupportedModels(w ErrorResponseWriter, r *http.Request) {
	...
	supportedModels := kclient.ProviderModels{
		...
		v1alpha2.ModelProviderFoundry: {
			...
			{Name: "DeepSeek-R1", FunctionCalling: false},
			{Name: "DeepSeek-R1-0528", FunctionCalling: false},
			{Name: "DeepSeek-V3-0324", FunctionCalling: true},
			{Name: "DeepSeek-V3.1", FunctionCalling: true},
			{Name: "DeepSeek-V3.2", FunctionCalling: false},
			{Name: "DeepSeek-V3.2-Speciale", FunctionCalling: false},
			{Name: "DeepSeek-V4-Flash", FunctionCalling: false},
			{Name: "DeepSeek-V4-Pro", FunctionCalling: false},
			{Name: "Kimi-K2.5", FunctionCalling: true},
			{Name: "Kimi-K2.6", FunctionCalling: true},
			{Name: "Llama-3.3-70B-Instruct", FunctionCalling: false},
			{Name: "Llama-4-Maverick-17B-128E-Instruct-FP8", FunctionCalling: false},
			{Name: "Mistral-Large-3", FunctionCalling: true},
			{Name: "gpt-chat-latest", FunctionCalling: true},
			{Name: "gpt-4", FunctionCalling: true},
			{Name: "gpt-4-turbo", FunctionCalling: true},
			{Name: "gpt-4o-mini", FunctionCalling: true},
			{Name: "gpt-5", FunctionCalling: true},
			{Name: "gpt-5-chat", FunctionCalling: true},
			{Name: "gpt-5-mini", FunctionCalling: true},
			{Name: "gpt-5-nano", FunctionCalling: true},
			{Name: "gpt-5.1", FunctionCalling: true},
			{Name: "gpt-5.1-chat", FunctionCalling: true},
			{Name: "gpt-5.2", FunctionCalling: true},
			{Name: "gpt-5.2-chat", FunctionCalling: true},
			{Name: "gpt-5.3-chat", FunctionCalling: true},
			...
			{Name: "gpt-4.1-nano", FunctionCalling: true},
			{Name: "gpt-4o", FunctionCalling: true},
			{Name: "grok-4", FunctionCalling: true},
			{Name: "grok-4-20-non-reasoning", FunctionCalling: true},
			{Name: "grok-4-20-reasoning", FunctionCalling: true},
			{Name: "grok-4.1-fast-non-reasoning", FunctionCalling: true},
			{Name: "grok-4.1-fast-reasoning", FunctionCalling: true},
			{Name: "grok-4.3", FunctionCalling: true},
			{Name: "grok-code-fast-1", FunctionCalling: true},
			{Name: "mistral-medium-3-5", FunctionCalling: false},
			{Name: "model-router", FunctionCalling: true},
			{Name: "o1", FunctionCalling: true},
			{Name: "o1-mini", FunctionCalling: true},
			{Name: "o3", FunctionCalling: true},
			{Name: "o3-mini", FunctionCalling: true},
			{Name: "o4-mini", FunctionCalling: true},
		},
