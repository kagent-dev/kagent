...
import (
	...
	cli "github.com/kagent-dev/kagent/go/cli/cli/agent"
	"github.com/kagent-dev/kagent/go/cli/cli/mcp"
	"github.com/kagent-dev/kagent/go/cli/config"
	"github.com/kagent-dev/kagent/go/cli/profiles"
...
func runInteractive(cmd *cobra.Command, args []string) {
	...
	if err := tui.RunWorkspace(cfg, cfg.Client(), cfg.Verbose, version.GetVersion()); err != nil {
