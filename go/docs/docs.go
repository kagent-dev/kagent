    ...
    "definitions": {
        ...
        "github_com_kagent-dev_kagent_go_controller_api_v1alpha1.ModelConfigSpec": {
            ...
            "properties": {
                ...
                "apiKeySecretRef": {
                    "description": "The reference to the secret that contains the API key. Can either be a reference to the name of a secret in the same namespace as the referencing ModelConfig, or a reference to the name of a Secret in a different namespace in the form \u003cnamespace\u003e/\u003cname\u003e\n+optional",
                    "type": "string"
                },
                "azureOpenAI": {
