...
func (a *kagentReconciler) validateCrossNamespaceReferences(ctx context.Context, agent *v1alpha2.Agent) error {
	...
	for _, tool := range agent.Spec.Declarative.Tools {
		...
		case tool.Agent != nil:
			if err := a.validateAgentReference(ctx, agent.Namespace, tool.Agent); err != nil {
				return err
			}
		}
	}
...
// validateAgentReference validates a reference to an Agent as a tool.
// This includes:
...
func (a *kagentReconciler) validateAgentReference(ctx context.Context, sourceNamespace string, ref *v1alpha2.TypedLocalReference) error {
