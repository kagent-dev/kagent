...
func (s *HTTPServer) setupRoutes() {
	...
	s.router.HandleFunc(APIPathToolServers+"/{namespace}/{name}/{groupKind}", adaptHandler(s.handlers.ToolServers.HandleGetToolServer)).Methods(http.MethodGet)
	s.router.HandleFunc(APIPathToolServers+"/{namespace}/{name}/{groupKind}", adaptHandler(s.handlers.ToolServers.HandleUpdateToolServer)).Methods(http.MethodPut)
